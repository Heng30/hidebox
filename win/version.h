...
#define PRODUCT_NAME           "hidebox" // 产品名称
...
#define INTERNAL_NAME          "hidebox.exe"
#define FILE_DESCRIPTION       "hidebox can append encrypt data to the end of file"  // 文件说明
#define LEGAL_COPYRIGHT        "Copyright 2023-2033 The Heng30 Company Ltd. All rights reserved." // 版权
#define ORIGINAL_FILE_NAME     "hidebox.exe"    // 原始文件名
